...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def app_exception_handler(req: Request, e: AppException) -> JSONResponse:
        """Handle custom sandbox business exceptions with a unified response structure."""
    ...
    async def http_exception_handler(req: Request, e: HTTPException) -> JSONResponse:
        """Handle HTTP exceptions raised by FastAPI with a unified response structure."""
    ...
    async def exception_handler(req: Request, e: Exception) -> JSONResponse:
        """Handle any unexpected sandbox service exception with a unified response structure."""
